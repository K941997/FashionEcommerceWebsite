...
@WebServlet(urlPatterns = {"/list-product-filtercheck-categories"})
public class ListProductFilterCheckCategoriesServlet extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//Loi Prices FilterCheck -> tach rieng Filter Prices
...
//		req.setAttribute("num", num);
		...
		req.getRequestDispatcher("/views/admin/list_product_filtercheck_categories.jsp").forward(req, resp);
