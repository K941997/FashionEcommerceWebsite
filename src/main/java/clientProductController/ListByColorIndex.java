...
@WebServlet(urlPatterns = {"/color-index"})
public class ListByColorIndex extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//Get List Product By ColorId:
		String sColorId = req.getParameter("colorId"); //JSP index.jsp color-index?colorId=
		...
		req.getRequestDispatcher("/views/client/index_list_product_by_color.jsp").forward(req, resp);
	}
}
