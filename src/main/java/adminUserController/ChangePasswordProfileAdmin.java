...
@WebServlet(urlPatterns = {"/change-password-profile-admin"})
public class ChangePasswordProfileAdmin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if(userWithOldPassword == null) {
				...
				req.getRequestDispatcher("profile-user-admin").forward(req, resp);
			} else {
				//Dung Password Old:
