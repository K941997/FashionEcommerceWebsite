...
<title>Add More Product Color Size</title>
...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="get-product-size-color?id=${requestScope.productNow.productId}">Home</a></li>
					<li class="breadcrumb-item active">Add More PCS</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							...
							<h5 class="card-title">Add More PCS</h5>
							
							<!-- ProductNow từ Servlet add-more-product-size-color (id của ProductNow lấy từ JSP list_product) 
							-->
							<c:set var="idProductNow" value="${requestScope.productNow.productId}"></c:set>
							<c:set var="nameProductNow" value="${requestScope.productNow.productName}"></c:set>
							<h5 hidden="" class="card-title"> Product ID: ${idProductNow}</h5>
							<h5 hidden="" class="card-title"> Product Name: ${nameProductNow}</h5>
	
								
							<!-- Hiển thị Error -->
							<p class="text-danger">${requestScope.errorAddMoreProductColorSizeServlet}</p>
							
									
							<form action="add-more-product-color-size?id=${idProductNow}" method="post" enctype="multipart/form-data">
								<input hidden="" type="number" name="id" value="${requestScope.productNow.productId}"/>
								<input hidden="" type="text" name="name" value="${requestScope.productNow.productName}"/>
								<!-- 
