...
<body class="animsition">
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('${urlAssets}/images/bg-01.jpg');">
		...
		<div class="container">
			<div class="row p-b-148">
				...
				<div class="col-11 col-md-5 col-lg-4 m-lr-auto">
					<div class="how-bor1 ">
						<div class="hov-img0">
							<img src="${urlAssets}/images/about-01.jpg" alt="IMG">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
					<div class="how-bor2">
						<div class="hov-img0">
							<img src="${urlAssets}/images/about-02.jpg" alt="IMG">
						</div>
					</div>
				</div>
			</div>
