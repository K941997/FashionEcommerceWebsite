									...
									<div class="block2-txt flex-w flex-t p-t-14">
										<div class="block2-txt-child1 flex-col-l ">
											...
											<span class="stext-105 cl3">
												...
												<fmt:formatNumber value="<%= productColorSizeDAO.getMinPricePCS(o.getProductId())%>" type="currency" currencyCode="VND" />
												-
												<fmt:formatNumber value="<%= productColorSizeDAO.getMaxPricePCS(o.getProductId())%>" type="currency" currencyCode="VND" />
											</span>
										</div>
...
<!--===============================================================================================-->
	...
	<script>
		//Trang này ko có Load More by AJAX:
	</script>
