...
@WebServlet(urlPatterns = {"/sort-index-price-desc"})
public class SortIndexByPriceDESC extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Product> listProductSortDESC = productDAO.getProductsByDecreasePrice();
		req.setAttribute("listProductClient", listProductSortDESC);
