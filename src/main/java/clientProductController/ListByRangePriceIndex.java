...
@WebServlet(urlPatterns = {"/index-list-product-by-range-price"})
public class ListByRangePriceIndex extends HttpServlet {
	@Override
...
//		String productListJson = gson.toJson(productList);
		...
		req.getRequestDispatcher("/views/client/index_list_product_by_range_price.jsp").forward(req, resp);
