		...
		<div class="pagetitle">
		 ...
		 <section class="section dashboard">
		   <div class="row">
		   	<div class="card">
		         <div class="card-body">
			           <h5 class="card-title">Danh sách Search Product</h5>
					...
					<!-- FilterCheckbox Mức Giá (Lọc theo Nhiều Giá): Tách Riêng -->
					 <div class="dropdown">
						...
						<!-- Search -->
						<c:set var="keySearch" value="${requestScope.keySearch}"></c:set>
		        			...
		        			<c:set var="page" value="${requestScope.page}"></c:set>
						  	<ul class="pagination d-flex justify-content-center ">
						    	<c:forEach begin="${1}" end="${requestScope.num}" var="i">
						    		<li class="page-item ">
			           					<a  class="page-link ${i==page?"active":""}"  href="search-product?page=${i}&keySearch=${keySearch}">${i}</a>
			           				</li>
			           			</c:forEach>
						  </ul>
						</nav>
		           ...
		           <table class="table">
		             ...
		             <tbody>
		             	<% 
		             	List<Product> productsSearchPagination = (List<Product>)request.getAttribute("productsSearchPagination");
				                
				                for (Product product : productsSearchPagination) {
