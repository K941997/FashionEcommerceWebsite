...
<head>
  ...
  <title>List Product By FilterCheck Categories</title>
		...
		<!-- List Product -->
		 <section class="section dashboard">
		   <div class="row">
		   	<div class="card">
		         <div class="card-body">
		           <h5 class="card-title">List Product By FilterCheck Categories</h5>
		           ...
		           <!-- Paginate (Phân trang) - Phân trang theo Danh Sách Products Theo CategoriesIds: (Chưa làm được)
		           <nav aria-label="..." >
	        			<c:set var="page" value="${requestScope.page }"></c:set>
					  	<ul class="pagination d-flex justify-content-center ">
					    	<c:forEach begin="${1}" end="${requestScope.num}" var="i">
					    		<li class="page-item ">
		           					<a  class="page-link ${i==page?"active":""}"  href="list-product?page=${i}&categoryId=${categoryId}">${i}</a>
		           				</li>
		           			</c:forEach>
					  </ul>
					</nav>
