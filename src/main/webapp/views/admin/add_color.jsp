			...
			<div class="row">
				<div class="card">
					<div class="card-body">
						...
						<!-- Hiển thị Error -->
						<p class="text-danger">${requestScope.errorAddColorServlet}</p>
						...
						<form action="add-color" method="post">
							<div hidden="" class="row mb-3">
								...
								<div class="col-sm-10">
									<input readonly="readonly" type="number" name="colorId" class="form-control">
								</div>
							</div>
							<div class="row mb-3">
								<label for="" class="col-sm-2 col-form-label">Name</label>
								<div class="col-sm-10">
									<input required="required" type="text" name="colorName" class="form-control">
								</div>
							</div>
