...
<body>
	...
	<main id="main" class="main">
		...
		<h1>List Color</</h1>
		  <nav>
		    <ol class="breadcrumb">
		      <li class="breadcrumb-item"><a href="list-color">Home</a></li>
		 ...
		 <section class="section dashboard">
		   <div class="row">
		   	<div class="card">
		         <div class="card-body">
		           <h1 class="card-title">List Color</h1>
		           
		           <a href="add-color" class="btn btn-primary mb-3">Add New</a>
	        			...
	        			<c:set var="page" value="${requestScope.page }"></c:set>
					  	<ul class="pagination d-flex justify-content-center ">
					    	<c:forEach begin="${1}" end="${requestScope.num}" var="i">
					    		<li class="page-item ">
		           					<a  class="page-link ${i==page?"active":""}"  href="list-color?page=${i}">${i}</a>
		           				</li>
		           			</c:forEach>
					  </ul>
					</nav>
		           ...
		           <table class="table">
		             ...
		             <tbody>
		             	<c:forEach items="${requestScope.colorsListColorServlet}" var="color">
		             	<tr>
		                   <th scope="row">${color.colorId}</th>
		                   <td>${color.colorName}</td>
		                   
		                 	<td>
		                 		<a href="update-color?id=${color.colorId}"><i class="fa-solid fa-pen-to-square"></i></a> |
		                 		<a href="#" onclick="deleteColor('${color.colorId}')"><i class="fa-solid fa-trash"></i></a>
		                 	</td>
		                </tr>
		             	</c:forEach>
		             </tbody>
	...
	<script type="text/javascript">
		function deleteColor(colorId){
			if(confirm("Do you want to Delete Color with ID: "+colorId)){
				window.location = "delete-color?id="+colorId;
			}
		}
	</script>
