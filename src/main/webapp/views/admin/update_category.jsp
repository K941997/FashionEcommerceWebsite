			...
			<div class="row">
				<div class="card">
					<div class="card-body">
						...
						<c:set var="category" value="${requestScope.categoryUpdateServlet}"></c:set>
						<h5 class="card-title">Update Category</h5>
						
						<!-- Hiển thị Error -->
						<p class="text-danger ">${requestScope.errorUpdateCategory}</p>
						...
						<form action="update-category" method="post">
							...
							<div hidden="" class="row mb-3">
								...
								<div class="col-sm-10">
									<input readonly="readonly" type="number" value="${category.categoryId}" 
						...
						 	
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input required="required" type="text" value="${category.categoryName}"
