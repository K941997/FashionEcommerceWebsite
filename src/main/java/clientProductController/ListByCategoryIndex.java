...
@WebServlet(urlPatterns = {"/category-index"})
public class ListByCategoryIndex extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//Get List Product By CategoryId:
		String sCategoryId = req.getParameter("cid"); //JSP index.jsp category?cid=
		...
		req.getRequestDispatcher("/views/client/index_list_product_by_category.jsp").forward(req, resp);
