			...
			<div class="row">
				<div class="card">
					<div class="card-body">
						...
						<!-- Hiển thị Error -->
						<p class="text-danger">${requestScope.errorAddCategoryServlet}</p>
						...
						<form action="add-category" method="post">
							...
							<div hidden="" class="row mb-3">
								...
								<div class="col-sm-10">
									 <input readonly="readonly" type="number" name="categoryId" class="form-control" />
								</div>
							</div>
		                   
		          
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input required="required" type="text" name="categoryName" class="form-control">
								</div>
							</div>
