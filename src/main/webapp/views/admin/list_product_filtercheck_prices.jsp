...
<head>
  ...
  <title>List Product By FilterCheck Prices</title>
		...
		<!-- List Product -->
		 <section class="section dashboard">
		   <div class="row">
		   	<div class="card">
		         <div class="card-body">
		           <h5 class="card-title">List Product By FilterCheck Prices</h5>
		           ...
		           <!-- TabList (Lọc theo 1 CategoryId):-->
		             <div class="dropdown">
						...
						<div class="dropdown-menu">
							...
							<a class="dropdown-item ${cid==0?"active":""}" href="list-product?categoryId=${0}">All</a>
			           		<c:forEach items="${cat}" var="c">		           			
			           				<a class="dropdown-item ${c.categoryId == categoryId?"active":""}" href="list-product?categoryId=${c.categoryId}">${c.categoryName}</a>
			           		</c:forEach> 
						</div>
					</div>
					...
					<!-- FilterCheckbox Categories (Lọc theo Nhiều CategoryIds): Tách Riêng -->
					 <div class="dropdown">
						...
						<div class="dropdown-menu">
							...
							<form id="f1" action="list-product">
		           ...
		           <!-- Pagination Phân trang cho FilterCheck Prices (Chưa làm được)
		            <nav aria-label="..." >
	        			<c:set var="page" value="${requestScope.page }"></c:set>
					  	<ul class="pagination d-flex justify-content-center ">
					    	<c:forEach begin="${1}" end="${requestScope.num}" var="i">
					    		<li class="page-item ">
		           					<a  class="page-link ${i==page?"active":""}"  href="list-product-filtercheck-prices?page=${i}&productPrices=${(i)}">${i}</a>
		           				</li>
		           			</c:forEach>
					  </ul>
					</nav>	 
