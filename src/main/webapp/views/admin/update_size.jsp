		...
		<section class="section dashboard">
			<div class="row">
				<div class="card">
					<div class="card-body">
						<!-- var="size" -->
						<c:set var="size" value="${requestScope.sizeUpdateServlet}"></c:set>
						<h5 class="card-title">Update Size</h5>

						<!-- Hiển thị Error -->
						<p class="text-danger">${requestScope.errorUpdateSize}</p>
						

						<!-- General Form Elements -->
						<form action="update-size" method="post">
							<div hidden="" class="row mb-3">
								<label for="" class="col-sm-2 col-form-label">ID</label>
								<div class="col-sm-10">
									<input readonly="readonly" type="num" value="${size.sizeId}" 
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input required="required" type="text" value="${size.sizeName}"
										name="sizeName" class="form-control">
								</div>
							</div>
