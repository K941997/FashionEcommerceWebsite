			...
			<div class="row">
				<div class="card">
					<div class="card-body">
						...
						<c:set var="user" value="${requestScope.userUpdateServlet}"></c:set>
						<h5 class="card-title">Update User</h5>
						
						<!-- Hiển thị Error -->
						<p class="text-danger ">${requestScope.errorUpdateUserServlet}</p>

						<!-- General Form Elements -->
						<form action="update-user" method="post" enctype="multipart/form-data">
						
							<div hidden="" class="row mb-3"> <!-- id PK Auto_increment nên có thể không thêm id này nên hidden, mà thêm id custom -->
								<label for="" class="col-sm-2 col-form-label">ID</label>
								<div class="col-sm-10">
									<input type="number" value="${user.userId}"
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input required="required" type="text" value="${user.email}"
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input required="required" type="password" value="${user.password}"
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input required="required" type="text" value="${user.fullname}"
										name="userFullname" class="form-control">
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10" >
									<c:if test="${user.avatar != null}">
                      					<img id="preview" alt="Image Preview" width="200" height="200" src='images/${user.avatar}' alt="Profile" name="userAvatar">
                      				</c:if>
									<input type="file" id="userAvatar" name="userAvatar" value="${user.avatar}" size="60" onchange="previewImage(event)"/>
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input required="required" type="text" value="${user.phone}"
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input required="required" type="text" value="${user.address}"
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input required="required" type="number" value="${user.role}"
