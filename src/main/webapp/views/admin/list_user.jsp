		   ...
		   <div class="row">
		   	<div class="card">
		         <div class="card-body">
		           ...
		           <a href="add-user" class="btn btn-primary mb-3">Add New</a>
	        			...
	        			<c:set var="page" value="${requestScope.page }"></c:set>
					  	<ul class="pagination d-flex justify-content-center ">
					    	<c:forEach begin="${1}" end="${requestScope.num}" var="i">
					    		<li class="page-item ">
		           					<a  class="page-link ${i==page?"active":""}"  href="list-user?page=${i}">${i}</a>
		           				</li>
		           			</c:forEach>
					  </ul>
					</nav>
		           ...
		           <table class="table">
		             ...
		             <tbody>
		             	<c:forEach items="${requestScope.usersListServlet}" var="user">
		             		<tr>
								...
								<td> 
									<c:if test="${user.avatar != null}">
                      		 			<img style="width: 100px; height: 100px" src='images/${user.avatar}' alt="Profile" name="avatar">
                      				</c:if>
								...
								<td>
									<c:if test="${sessionScope.userLoginServlet.role == 1}">
										<a href="update-user?id=${user.userId}"><i class="fa-solid fa-pen-to-square"></i></a> |
										<a href="#" onclick="deleteUser('${user.userId}')"><i class="fa-solid fa-trash"></i></a>
									</c:if>
