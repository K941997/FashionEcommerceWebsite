...
<head>
  ...
  <title>List Category Admin</title>
...
<body>
	...
	<main id="main" class="main">
		...
		<h1>List Category</</h1>
		  <nav>
		    <ol class="breadcrumb">
		      <li class="breadcrumb-item"><a href="list-category">Home</a></li>
		   ...
		   <div class="row">
		   	<div class="card">
		         <div class="card-body">
			           ...
			           <a href="add-category" class="btn btn-primary mb-3">Add New</a>
		        			...
		        			<c:set var="page" value="${requestScope.page }"></c:set>
						  	<ul class="pagination d-flex justify-content-center ">
						    	<c:forEach begin="${1}" end="${requestScope.num}" var="i">
						    		<li class="page-item ">
			           					<a  class="page-link ${i==page?"active":""}"  href="list-category?page=${i}">${i}</a>
			           				</li>
			           			</c:forEach>
						  </ul>
						</nav>
			           ...
			           <table class="table">
			             ...
			             <tbody>
			             	<c:forEach items="${requestScope.categoriesListServlet}" var="cate">
			             		<tr>
				             		<th scope="row">${cate.categoryId}</th>
				                 
				                   	<td>${cate.categoryName}</td>
				                 	<td>
				                 		<a href="update-category?id=${cate.categoryId}"><i class="fa-solid fa-pen-to-square"></i></a> |
				                 		<a href="#" onclick="deleteCategory('${cate.categoryId}')"><i class="fa-solid fa-trash"></i></a>
				                 	</td>
			                	</tr>
			             	</c:forEach>
			             </tbody>
	...
	<script type="text/javascript">
		function deleteCategory(categoryId){
			if(confirm("Do you want to Delete Category with ID: "+categoryId)){
				window.location = "delete-category?id="+categoryId;
			}
		}
