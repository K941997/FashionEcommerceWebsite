	...
	<main id="main" class="main">
		...
		<section class="section dashboard">
			<div class="row">
				<div class="card">
					<div class="card-body">
						<c:set var="color" value="${requestScope.colorUpdateServlet}"></c:set>
						<h5 class="card-title">Update Color</h5>

						<!-- Hiển thị Error -->
						<p class="text-danger">${requestScope.errorUpdateColor}</p>
						...
						<form action="update-color" method="post">
							<div hidden="" class="row mb-3">
								...
								<div class="col-sm-10">
									<input readonly="readonly" type="number" value="${color.colorId}"
										name="colorId" class="form-control">
								</div>
							</div>
							<div class="row mb-3">
								<label for="" class="col-sm-2 col-form-label">Name</label>
								<div class="col-sm-10">
									<input required="required" type="text" value="${color.colorName}"
