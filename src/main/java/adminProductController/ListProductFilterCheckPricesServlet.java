...
@WebServlet(urlPatterns = {"/list-product-filtercheck-prices"})
public class ListProductFilterCheckPricesServlet extends HttpServlet {
	@Override
...
//		//FilterCheckbox Prices (Lọc theo Nhiều Prices): Tách riêng JSP/Servlet:
		...
		//Paginate (Phân trang) Cho FilterCheck Prices - Phân trang theo Danh Sách Products Theo Prices: (Chưa làm được)
...
//		
//		List<Product> productsFilterPricesPagination = new ArrayList<Product>();
//		productsFilterPricesPagination = productDAO.getProductsByPage(products, start, end);
//		
//		req.setAttribute("productsFilterPricesPagination", productsFilterPricesPagination);
//		req.setAttribute("page", page);
//		req.setAttribute("num", num);
		
		//Final:
		req.setAttribute("products", products);
		req.getRequestDispatcher("/views/admin/list_product_filtercheck_prices.jsp").forward(req, resp);
	}
